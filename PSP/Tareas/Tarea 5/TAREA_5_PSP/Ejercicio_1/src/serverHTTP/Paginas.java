...
public class Paginas {
  ...
  public static String cabeceraFecha (){
       // Crear una instancia de un objeto Date invocando su constructor 
        ...
        SimpleDateFormat formatoDia = new SimpleDateFormat(strDateFormat); // La cadena de formato de fecha se pasa como un argumento al objeto 
        return formatoDia.format(objDate);
  }
}