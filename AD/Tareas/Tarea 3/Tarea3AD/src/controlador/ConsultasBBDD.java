...
public class ConsultasBBDD {
    ...
    public void mostrarInformacionBBDD() throws SQLException {
        try {
            ...
            while (resul.next()) {
                ...
                String esquema = resul.getString(1); // columna 2
                String tabla = resul.getString(3); // columna 3
                String tipo = resul.getString(4); // columna 4
                System.out.printf("%s - Esquema: %s, Nombre Tabla: %s %n", tipo, esquema, tabla);
            }
            System.out.println("");
    ...
    public void consultaPasajeros() throws SQLException {
        ...
        if (conexionBBDD == null) {
            ...
            System.out.println("Número|Código vuelo|Tipo plaza|Fumador");
            System.out.println("-----------------------------------------");
    ...
    public void consultaPasajerosVuelo(String codigoVuelo) throws SQLException {
        ...
        if (conexionBBDD == null) {
            ...
            if (!resultado.next()) {
                ...
                System.out.println("\nNúmero|Código vuelo|Tipo plaza|Fumador");
                System.out.println("-----------------------------------------");
    ...
    public void borrarVuelo(String codigoVuelo) throws SQLException {
        ...
        if (conexionBBDD == null) {
            ...
            //Cerramos todas las conexiones
            System.out.println("El vuelo " + codigoVuelo + " se ha borrado de la tabla vuelos");
            ps.close();
            conexionBBDD.getConexion().close();
        }
